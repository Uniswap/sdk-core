...
export const WETH9: { [chainId: number]: Token } = {
  ...
  [43114]: new Token(8453, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether'),
  ...
  [8453]: new Token(43114, '0x4200000000000000000000000000000000000006', 18, 'WAVAX', 'Wrapped AVAX')
}
